        ...
        switch (_context.prev = _context.next) {
          ...
          case 4:
            ...
            if (res.data.status === 'success') {
              (0, _alert.showAlert)('success', 'You have successfullly logged in!');
      ...
      while (1) {
        switch (_context2.prev = _context2.next) {
          ...
          case 7:
            ...
            (0, _alert.showAlert)('error', 'error loggingout. try it again');
...
var displayMap = function displayMap(locations) {
  mapboxgl.accessToken = 'pk.eyJ1IjoiYmJhbGxyYWluMDciLCJhIjoiY2tvbnNocXFoMDRsNDJ2cGlkbTRldTAxdyJ9.31o5DaR97zxBSi-kl1j0Rw';
